...
/**
 * Four-step token setup wizard (HF → Groq → OpenRouter → Gemini) shown after first Save.
 */
@Composable
fun TokenSetupWizard(
    ...
    val steps = listOf(
        ...
        Triple("Google Gemini", TokenPortals.GEMINI, geminiConfigured),
    )
            ...
            Column {
                Text(
                    when (title) {
                        ...
                        "Google Gemini" ->
                            "Optional: Google AI Studio free tier gives fast multimodal reasoning and Gemini 2.5 Flash coding."
                        else ->
