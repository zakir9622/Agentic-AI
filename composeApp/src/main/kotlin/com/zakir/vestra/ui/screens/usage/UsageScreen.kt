...
fun UsageScreen(
    ...
    val usageDashboardData by apiKeyDataStore?.usageDashboardFlow?.collectAsState(initial = ApiKeyDataStore.ApiUsageDashboardData())
        ?: remember { mutableStateOf(ApiKeyDataStore.ApiUsageDashboardData()) }
    val scope = rememberCoroutineScope()

    GlassScreen(title = "Cloud usage", subtitle = "Telemetry & Token Monitor", onBack = onBack) {
