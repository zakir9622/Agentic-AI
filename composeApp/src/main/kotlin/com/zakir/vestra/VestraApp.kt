...
class VestraApp : Application() {
    ...
    lateinit var apiKeyDataStore: com.zakir.vestra.storage.ApiKeyDataStore
        private set
    ...
    override fun onCreate() {
        ...
        TokenSidecar.applyDefaultGeminiIfBlank(appSettings, BuildConfig.DEFAULT_GEMINI_TOKEN)
