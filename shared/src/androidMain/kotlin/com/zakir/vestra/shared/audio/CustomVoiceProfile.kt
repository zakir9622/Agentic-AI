...
object CustomVoiceStorage {
    ...
    fun loadProfiles(dir: File): List<CustomVoiceProfile> {
        ...
        return runCatching {
            ...
            // Self-heal like the file-missing branch above — otherwise a corrupt file (partial
            // write, manual edit) keeps re-deriving defaults on every call without ever fixing
            // the file on disk.
            val defaults = defaultSampleProfiles(dir)
            saveProfiles(dir, defaults)
            defaults
