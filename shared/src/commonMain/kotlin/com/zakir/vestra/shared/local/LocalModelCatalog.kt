...
object LocalModelCatalog {
    val entries: List<LocalModelEntry> = listOf(
        ...
        LocalModelEntry(
            ...
            displayName = "BiRefNet matting (planned)",
            ...
            approxSizeLabel = "~50–200 MB",
            runnable = false,
            testingNote = "Quality pack reserved: birefnet-v1. Improves Lite/Pro edges once shipped.",
        ),
        LocalModelEntry(
            id = "local-quality-realesrgan",
            displayName = "Real-ESRGAN upscale (planned)",
            ...
            runnable = false,
            testingNote = "Quality pack reserved: realesrgan-v1. Seller listing polish path.",
        ),
        LocalModelEntry(
