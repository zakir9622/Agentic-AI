...
/**
 * A named [VoiceKnobs] combination for one-tap voice transformation — distinct from
 * [VoicePersona] (which picks a TTS narrator voice, not a DSP transform applied to existing
 * audio). Consumed by AudioEditorEngine.transformVoicePreset for the vocal-editor pipeline.
 */
