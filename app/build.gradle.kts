...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "DEFAULT_GEMINI_TOKEN", "\"\"")
    }
    ...
    buildTypes {
        debug {
            ...
            val groqDefault = (localProps.getProperty("lookbook.groq.token")
                ...
                ?: "").replace("\\", "\\\\").replace("\"", "\\\"")
            val geminiDefault = (localProps.getProperty("lookbook.gemini.token")
                ?: System.getenv("LOOKBOOK_GEMINI_TOKEN")
            ...
            buildConfigField("String", "DEFAULT_GEMINI_TOKEN", "\"$geminiDefault\"")
        }
        release {
