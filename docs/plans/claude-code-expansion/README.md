...
| cycle3-ui-settings | Settings split, model health, generation feedback | **PARTIAL** — hub/wizard done; live health badges TBD |
| cycle4-speed-compliance | QNN EP, LCM, safety classifier, UI tests | **PARTIAL** — hooks present; not fully productized |
